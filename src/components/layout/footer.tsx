        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li>
                <Link href="/ranking" className="hover:text-gray-900 dark:hover:text-white">
                  랭킹
                </Link>
              </li>
              <li>
                <Link href="/genre" className="hover:text-gray-900 dark:hover:text-white">
                  장르별
                </Link>
              </li>
              <li>
                <Link href="/new" className="hover:text-gray-900 dark:hover:text-white">
                  신작
                </Link>
              </li>
              <li>
                <Link href="/completed" className="hover:text-gray-900 dark:hover:text-white">
                  완결작
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li>
                <Link href="/author/register" className="hover:text-gray-900 dark:hover:text-white">
                  작가 등록
                </Link>
              </li>
              <li>
                <Link href="/author/guide" className="hover:text-gray-900 dark:hover:text-white">
                  작가 가이드
                </Link>
              </li>
              <li>
                <Link href="/author/revenue" className="hover:text-gray-900 dark:hover:text-white">
                  수익 정책
                </Link>
              </li>
            </ul>
